CREATE TABLE "public"."surveys_invites" (
  ...
  CONSTRAINT "surveys_invites_survey_id_fkey" FOREIGN KEY("survey_id") REFERENCES "Survey"("survey_id"),
  CONSTRAINT "surveys_invites_user_id_fkey" FOREIGN KEY("user_id") REFERENCES "Users"("user_id")
);
